...
// export const userLogin = (values : object) => axiosInstance('JwtToken').post('/admin/roleLogIn' ,values)  
export const adminLogin = (values : object) => axiosInstance('adminToken').post('/admin/roleLogIn' ,values)  
export const blockAndBlock = (values : object) => axiosInstance('JwtToken').post('/admin/blockAndBlock' ,values)  

export const getUserData = () => axiosInstance('adminToken').get('/admin/getUserData')  